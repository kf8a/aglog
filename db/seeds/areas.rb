...
Area.find_or_create_by(name: 'LYSIMETER_FIELD',
                       treatment_id: t,
                       study_id: 9,
...
main = Area.find_or_create_by(name: 'T', study_id: study.id,
                              company_id: company.id)
1.upto(6) do |rep|
  1.upto(8) do |treat|
...
biodiversity = Area.find_or_create_by(name: 'B', study_id: study.id,
                                      company_id: company.id)
biodiversity.save
1.upto(4) do |rep|
  1.upto(21) do |treat|
...
n_rate = Area.find_or_create_by(name: 'F', study_id: study.id,
                                company_id: company.id)
1.upto(4) do |rep|
  1.upto(9) do |treat|
...
irrigated_n_rate = Area.find_or_create_by(name: 'iF', study_id: study.id,
                                          company_id: company.id)
1.upto(4) do |rep|
  1.upto(9) do |treat|
...
glbrc = Area.find_or_create_by(name: 'G', study_id: study.id,
                               company_id: company.id)
1.upto(5) do |rep|
  1.upto(10) do |trt|
...
ces = Area.find_or_create_by(name: 'CE', study_id: study.id,
                             company_id: company.id)
1.upto(4) do |rep|
  plot = rep * 100
  1.upto(19) do |trt|
...
wicst = Area.find_or_create_by(name: 'WICST', study_id: study.id,
                               company_id: company.id)
